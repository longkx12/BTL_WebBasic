    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detailProduct.aspx.cs" Inherits="BTL_Web.detailProduct" %>
    ...
    <section class="content">
        <div class="container flex" id="detail">
            <%
                ...
                List<BTL_Web.Objects.products> products = (List<BTL_Web.Objects.products>)Application["listProduct_All"];
                foreach (BTL_Web.Objects.products product in products)
                {
            ...
            <div class="right">
                ...
                <button onclick="confirmDelete()">Xóa sản phẩm</button>
                <%} %>
                <% } %>
            </div>
        </div>
